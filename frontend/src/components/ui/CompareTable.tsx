...
const CompareTable: React.FC<CompareTableProps> = ({ classone, classtwo, imageSrc1, imageSrc2, classoneResponse, classtwoResponse }) => {
    return (
        <div className="mt-10 flex items-center justify-center space-x-4 p-10 border rounded-2xl bg-black overflow-auto">
            <div className="flex flex-col items-center pr-7">
                ...
                <div className='mt-5'>
                    ...
                    <ReactMarkdown className="text-white text-lg whitespace-pre-wrap">{classoneResponse}</ReactMarkdown>
                </div>
            </div>
            <div className="flex flex-col items-center border-l-2 pl-7">
                ...
                <div className='mt-5'>
                    ...
                    <ReactMarkdown className="text-white text-lg whitespace-pre-wrap">{classtwoResponse}</ReactMarkdown>
                </div>
            </div>
        </div>
    );
